                ...
                <tbody>
                    @foreach ($testimonials as $testimonial)
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset('uploads/testimonials') }}/{{ $testimonial->client_image }}" alt="" class="img-fluid rounded-circle">
                            </td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="{{ route('testimonial.edit', $testimonial->client_name_slug) }}" class="dropdown-item"><i class="fas fa-edit"></i>Edit</a></li>
                                        <li>
