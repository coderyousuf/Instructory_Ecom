        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="client_message" class="form-control @error('client_message')
                    is-invalid
                    @enderror" placeholder="enter Client message" id="">
                ...
                <div class="mb-3 form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" name="is_active" id="activeStatus" checked>
